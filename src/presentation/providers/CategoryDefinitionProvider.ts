...
export class CategoryDefinitionProvider implements DefinitionProvider {
    ...
    constructor() {
        ...
        this.logger = ServiceContainer.getService<ILogger>(SERVICE_TOKENS.Logger).createChild('CategoryDefinitionProvider');
    ...
    async provideDefinition(
        ...
        try {
            ...
            // 创建定义位置
            const targetPosition = category.lineNumber !== undefined 
                ? new Position(category.lineNumber, 0) 
                : new Position(0, 0);
