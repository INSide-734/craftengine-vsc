import { type StatusBarItem, StatusBarAlignment, window, ThemeColor } from 'vscode';
...
export class DiagnosticStatusBarManager {
    ...
    private setupEventListeners(): void {
        ...
        this.subscriptions.push(
            this.eventBus.subscribe('diagnostics.statistics', (event: unknown) => {
        ...
        // 监听模板扫描事件
        this.subscriptions.push(
            this.eventBus.subscribe('template.scan.started', () => {
                this.showLoading('Scanning templates...');
            }),
        );

        this.subscriptions.push(
            this.eventBus.subscribe('template.scan.completed', () => {
        ...
        // 监听模板缓存重建事件
        this.subscriptions.push(
            this.eventBus.subscribe('template.cache.rebuilding', () => {
                this.showLoading('Rebuilding cache...');
            }),
        );

        this.subscriptions.push(
            this.eventBus.subscribe(EVENT_TYPES.TemplateCacheRebuilt, () => {
