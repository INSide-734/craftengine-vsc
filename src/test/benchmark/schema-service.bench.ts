...
describe('Schema Service Performance', () => {
    ...
    describe('LRU Cache Operations', () => {
        ...
        bench(
            'cache set with eviction (100 items)',
            () => {
    ...
    describe('Schema Path Navigation', () => {
        ...
        bench(
            'navigate CraftEngine items path',
            () => {
        ...
        bench(
            'navigate CraftEngine templates path',
            () => {
        ...
        bench(
            'navigate CraftEngine deep path',
            () => {
                navigateSchemaPath(craftEngineSchema, ['items', 'default:phoenix_staff', 'data', 'lore']);
            },
            defaultBenchOptions,
        );
    });
    ...
    describe('Schema Availability Check (hasSchemaForPath)', () => {
        ...
        bench(
            'check CraftEngine path with patterns',
            () => {
        ...
        bench(
            'check path with additionalProperties',
            () => {
    ...
    describe('Pattern Matching (patternProperties)', () => {
        bench(
            'match against 5 patterns (hit on first)',
            () => {
        ...
        bench(
            'match against 5 patterns (hit on last)',
            () => {
        ...
        bench(
            'match against 5 patterns (no match)',
            () => {
        ...
        bench(
            'CraftEngine item pattern match (namespace:name)',
            () => {
        ...
        bench(
            'CraftEngine item pattern match (simple name)',
            () => {
    ...
    describe('Property Extraction', () => {
        ...
        bench(
            'extract CraftEngine item properties',
            () => {
    ...
    describe('Cached Operations', () => {
        ...
        bench(
            'property extraction with cache',
            () => {
                const cache = new LRUCache<string, any[]>(200);
    ...
    describe('Typical Usage Patterns', () => {
        bench(
            'completion scenario - get available properties',
            () => {
        ...
        bench(
            'hover scenario - get property details',
            () => {
        ...
        bench(
            'validation scenario - check multiple paths',
            () => {
                const paths = [
        ...
        bench(
            'autocomplete - shouldActivate check',
            () => {
