 ...
 * - sound.attack.hit
 */
function generateTranslationKey(index: number, languageCode: string = 'en', fileIndex: number = 0): ITranslationKey {
    const categories = ['item', 'message', 'gui', 'category', 'sound', 'lore', 'tooltip', 'error'];
    const subKeys = ['name', 'description', 'lore', 'title', 'button', 'placeholder', 'warning', 'success'];
...
describe('TranslationStore Performance', () => {
    ...
    describe('Add Operations', () => {
        ...
        bench(
            'add multi-language keys (100 keys × 8 languages)',
            () => {
                const store = new MockTranslationStore();
        ...
        bench(
            'add CraftEngine style keys (50 items)',
            () => {
                const store = new MockTranslationStore();
    ...
    describe('Query by Name (Exact Match)', () => {
        ...
        bench(
            'get by name (100 keys) - not exists',
            () => {
        ...
        bench(
            'get by name (1000 keys) - not exists',
            () => {
        ...
        bench(
            'get by name (multi-language, same key in 8 languages)',
            () => {
    ...
    describe('Query by Language', () => {
        ...
        bench(
            'get by language (100 keys per lang)',
            () => {
        ...
        bench(
            'get by language (500 keys per lang)',
            () => {
    ...
    describe('Prefix Search', () => {
        ...
        bench(
            'search prefix "item.item_5" (500 keys)',
            () => {
        ...
        bench(
            'search prefix (1000 keys) - narrow',
            () => {
        ...
        bench(
            'search prefix (1000 keys) - no match',
            () => {
        ...
        bench(
            'search CraftEngine keys - "item.jade"',
            () => {
        ...
        bench(
            'search CraftEngine keys - "item.phoenix"',
            () => {
        ...
        bench(
            'search CraftEngine keys - "category"',
            () => {
    ...
    describe('Fuzzy Search', () => {
        ...
        bench(
            'fuzzy search (1000 keys) - single word',
            () => {
        ...
        bench(
            'fuzzy search (1000 keys) - partial match',
            () => {
        ...
        bench(
            'fuzzy search CraftEngine keys - "sword"',
            () => {
        ...
        bench(
            'fuzzy search CraftEngine keys - "lore"',
            () => {
    ...
    describe('Remove Operations', () => {
        ...
        bench(
            'remove by file (10 keys per file)',
            () => {
                const store = new MockTranslationStore();
        ...
        bench(
            'remove by file (50 keys per file)',
            () => {
                const store = new MockTranslationStore();
    ...
    describe('Typical Usage Patterns', () => {
        bench(
            'autocomplete scenario - search then sort',
            () => {
                const store = new MockTranslationStore();
        ...
        bench(
            'diagnostic scenario - check key exists in all languages',
            () => {
                const store = new MockTranslationStore();
        ...
        bench(
            'hover scenario - get translation value',
            () => {
                const store = new MockTranslationStore();
                multiLangKeys100.forEach((k) => store.add(k));
        ...
        bench(
            'file reload scenario - remove and re-add',
            () => {
                const store = new MockTranslationStore();
                // 初始添加
                for (let i = 0; i < 100; i++) {
        ...
        bench(
            'CraftEngine i18n completion - search item translations',
            () => {
                const store = new MockTranslationStore();
        ...
        bench(
            'CraftEngine l10n validation - check translation exists',
            () => {
                const store = new MockTranslationStore();
                craftEngineKeys200.forEach((k) => store.add(k));
    ...
    describe('Edge Cases', () => {
        ...
        bench(
            'single character prefix search',
            () => {
                const store = new MockTranslationStore();
                keys500.forEach((k) => store.add(k));
                store.searchKeys('i');
    ...
    describe('Large Scale Operations', () => {
        ...
        bench(
            'get by language in 4000 keys (500 per lang × 8 langs)',
            () => {
                const store = new MockTranslationStore();
