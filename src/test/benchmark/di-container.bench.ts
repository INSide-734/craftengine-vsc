...
describe('DependencyContainer Performance', () => {
    ...
    describe('Service Registration', () => {
        ...
        bench(
            ...
            () => {
                ...
                container.registerFactory(token, () => new SimpleService(), ServiceLifetime.Singleton);
                container.dispose();
            },
            defaultBenchOptions,
        );
        ...
        bench(
            ...
            () => {
                const container = new DependencyContainer();
                const token = createToken('factory');
                container.registerFactory(token, () => new SimpleService(), ServiceLifetime.Transient);
                container.dispose();
            },
            defaultBenchOptions,
        );
    ...
    describe('Service Resolution - Singleton Factory', () => {
        ...
        bench(
            'resolve singleton (first call creates)',
            () => {
                const container = new DependencyContainer();
                container.registerFactory(singletonToken, () => new SimpleService(), ServiceLifetime.Singleton);
        ...
        bench(
            'resolve singleton 100 times (cached after first)',
            () => {
                const container = new DependencyContainer();
                container.registerFactory(singletonToken, () => new SimpleService(), ServiceLifetime.Singleton);
                for (let i = 0; i < 100; i++) {
    ...
    describe('Service Resolution - Transient Factory', () => {
        ...
        bench(
            'resolve transient (creates new each time)',
            () => {
                const container = new DependencyContainer();
                container.registerFactory(transientToken, () => new SimpleService(), ServiceLifetime.Transient);
    ...
    describe('Service Query Operations', () => {
        ...
        bench(
            'check service existence (exists)',
            () => {
                const container = new DependencyContainer();
        ...
        bench(
            'check service existence (not exists)',
            () => {
                const container = new DependencyContainer();
    ...
    describe('Large Scale Operations', () => {
        bench(
            'register and resolve 100 services',
            () => {
                const container = new DependencyContainer();
                for (let i = 0; i < 100; i++) {
    ...
    describe('Typical Usage Patterns', () => {
        bench(
            'CraftEngine service initialization pattern',
            () => {
                const container = new DependencyContainer();
