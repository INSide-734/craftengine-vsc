import { type EditorTextDocument, type EditorUri } from '../../core/types/EditorTypes';
import {
    type ITemplateService,
    type ITemplateParseResult,
    type ITemplateMatch,
...
export class TemplateService implements ITemplateService {
    ...
    async isTemplateAvailableAt(templateName: string, _context: ITemplateUsageContext): Promise<boolean> {
