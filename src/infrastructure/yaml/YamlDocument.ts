import { type Uri, type Position, type Range } from 'vscode';
import {
    type IYamlDocument,
    type IYamlNode,
    type IYamlParseResult,
    type IYamlParseError,
    type YamlNodeType,
    type YamlValue,
...
export function buildNodeTree(
    ...
    return new YamlNode(type, obj as YamlValue, position, parent, children.size > 0 ? children : undefined, path);
}
