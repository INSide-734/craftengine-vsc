import { type Uri, workspace, type FileSystemWatcher, RelativePattern } from 'vscode';
import {
    type IFileWatcher,
    type IFileChangeEvent,
    type IFileWatchOptions,
    FileChangeType,
...
export class VSCodeFileWatcher implements IFileWatcher {
     ...
     * 处理文件变更事件
     */
    private handleFileChange(uri: Uri, type: FileChangeType, _watchPath: string, options: IFileWatchOptions): void {
        // 应用排除过滤器
