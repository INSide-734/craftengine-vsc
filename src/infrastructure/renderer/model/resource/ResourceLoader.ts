...
import { ResourcePack, DirectoryResourcePack, InternalResourcePack, ZipResourcePack } from './ResourcePack';
  ...
  constructor(
    ...
    for (const packPath of packPaths) {
      ...
      if (stat.isDirectory()) {
        ...
        throw new Error(`Unsupported resource pack format: ${packPath}. Only directories and .zip files are supported.`);
      }
    }
