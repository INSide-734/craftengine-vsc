...
import { GeometricalModel, LayeredModel, type Model } from './Model';
...
export class UnresolvedModel {
    ...
    constructor(
        ...
        this.translation = gui?.translation
            ? new Vector3d(gui.translation[0], gui.translation[1], gui.translation[2])
            : null;
