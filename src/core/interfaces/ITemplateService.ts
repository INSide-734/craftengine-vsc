import { type EditorUri, type EditorTextDocument, type EditorPosition, type EditorRange } from '../types/EditorTypes';
import { type ITemplate, type ITemplateValidationResult } from './ITemplate';
...
export interface ITemplateService {
     ...
     * ```
     */
    isTemplateAvailableAt(templateName: string, context: ITemplateUsageContext): Promise<boolean>;
     ...
     * ```
     */
    getParameterSuggestions(templateName: string, existingParameters: string[]): Promise<string[]>;
